...
&nbsp;
  let callback;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (_.isFunction(last)) {
<span class="cstat-no" title="statement not covered" >    callback = last;</span>
<span class="cstat-no" title="statement not covered" >    args = _.dropRight(args);</span>
  }
&nbsp;
...
&nbsp;
  getBlockByHash(...args) {
    const [[hash, { summary = false, extension = <span class="branch-0 cbranch-no" title="branch not covered" >'json' </span>} = <span class="branch-0 cbranch-no" title="branch not covered" >{}]</span>, callback] = source(...args);
&nbsp;
    return Promise.try(() =&gt; {
...
&nbsp;
  getBlockHeadersByHash(...args) {
    const [[hash, count, { extension = <span class="branch-0 cbranch-no" title="branch not covered" >'json' </span>} = <span class="branch-0 cbranch-no" title="branch not covered" >{}]</span>, callback] = source(...args);
&nbsp;
    return Promise.try(() =&gt; {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Aug 22 2016 17:03:31 GMT+0100 (WEST)
</div>
</div>
